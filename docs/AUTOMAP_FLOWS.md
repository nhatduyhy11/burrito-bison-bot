...
| Có post-map blocker | Sau hai fallback click, tìm các template trong `rooms/blocker/`, click blocker đầu tiên match rồi scan lại. `overlay_newbie.png` dùng crop quyển sách không chứa chữ để detect, nhưng màn hướng dẫn đóng bằng "nhấn khu vực trống" nên click tọa độ cố định `(157, 54)` ở vùng đen bên trái banner tiêu đề; blocker khác dùng tâm. | Không đánh dấu hoàn tất khi blocker còn che home. |
